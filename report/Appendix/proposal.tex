...
\begin{itemize}
    ...
    \item \textbf{Tài liệu học tập:} Bao gồm nhiều dạng nội dung như ghi chú (Notes), thẻ ghi nhớ (Flashcards), bài kiểm tra (Tests).
...
\hline
\endhead
03/05/26 -- 21/05/26 & Sprint 10: Social & Phát triển chức năng Social (cộng đồng học tập), bao gồm khám phá và chia sẻ học liệu công khai, tương tác giữa người dùng, xây dựng giao diện trang Social và tích hợp API vào hệ thống \\
\hline
