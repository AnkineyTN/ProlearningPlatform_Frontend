...
\begin{itemize}
    ...
    \item \textbf{Tài liệu học tập:} Bao gồm nhiều dạng nội dung như ghi chú (Notes), thẻ ghi nhớ (Flashcards), bài kiểm tra (Exams).
...
\begin{itemize}
    ...
    \item \textbf{Exam:} Tạo bài kiểm tra từ ghi chú và tài liệu với nhiều dạng câu hỏi cùng với khả năng phân tích kết quả bài làm để xác định lỗ hổng kiến thức.
...
\textbf{1. Version 1: Chức năng học tập chính (Note, Flashcard và Exam)}
...
\textbf{2. Version 2: Chức năng học tập bổ trợ (To Do List và Pomodoro)}
