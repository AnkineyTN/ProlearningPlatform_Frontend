...
\usepackage{graphicx}
\usepackage{grffile} % Hỗ trợ tên file có dấu cách và ký tự đặc biệt
\usepackage[font=footnotesize]{caption} % Chỉnh font chữ caption nhỏ lại
\graphicspath{ {images/} {images/use-case-diagram/} }
...
% ========================================================================================= %
\newcommand{\tenSV}{Trịnh~Nguyên~Lương~-~Hoàng~Lê~Nam~-~Trần~Thảo~Ngân~-~Nguyễn~Thanh~Nhã} % Dấu ~ là khoảng trắng không được tách (các chữ nối với nhau bằng dấu ~ sẽ nằm cùng 1 dòng
\newcommand{\mssv}{1234567}
\newcommand{\tenKL}{Sử~dụng~LaTeX trong Khoá~luận~tốt~nghiệp} % Chú ý dấu ~ trong tên khóa luận
\newcommand{\tenGVHD}{Nguyễn~Thị~Minh~Tuyền}
\newcommand{\tenBM}{Kỹ thuật phần mềm}
