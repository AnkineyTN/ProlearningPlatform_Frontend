...
\begin{figure}[H]
  \centering
  \includegraphics[width=\textwidth]{uc-auth.jpg}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=\textwidth]{uc-profile.jpg}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=\textwidth]{uc-admin.jpg}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=\textwidth]{uc-set.jpg}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=\textwidth]{uc-note.jpg}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=\textwidth]{uc-flashcard.jpg}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=\textwidth]{uc-exam.jpg}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=\textwidth]{uc-todo-goal.jpg}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=\textwidth]{uc-pomodoro.jpg}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=\textwidth]{uc-analytics.jpg}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=\textwidth]{uc-roadmap.jpg}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=\textwidth]{uc-community.jpg}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=\textwidth]{uc-notification.jpg}
...
Hệ thống cần cung cấp môi trường tập trung để người dùng lưu trữ, tổ chức và truy cập các tài nguyên học tập trên cùng một nền tảng, bao gồm: ghi chú, tài liệu PDF, DOCX, bài trình chiếu, nội dung website, video học tập và các tài nguyên do hệ thống sinh ra.

\subsection{Hỗ trợ xây dựng và quản lý tri thức cá nhân}

Hệ thống cần hỗ trợ người dùng xây dựng kho tri thức cá nhân có cấu trúc thông qua các chức năng:
\begin{itemize}
    \item Tạo và chỉnh sửa ghi chú.
...
\subsection{Hỗ trợ tạo nội dung học tập bằng mô hình ngôn ngữ lớn}

Hệ thống cần ứng dụng mô hình ngôn ngữ lớn (LLM) để tự động hóa việc tạo nội dung học tập, bao gồm:
\begin{itemize}
    \item Tóm tắt và giải thích nội dung tài liệu.
    \item Sinh ghi chú, Flashcard và bài kiểm tra từ tài liệu đầu vào.
    \item Hỗ trợ xây dựng các tài nguyên học tập bổ sung theo yêu cầu.
\end{itemize}

\subsection{Hỗ trợ học tập chủ động}

Hệ thống cần cung cấp công cụ giúp người học chuyển từ tiếp nhận thụ động sang luyện tập có chủ đích, bao gồm: ôn tập bằng Flashcard, tự kiểm tra kiến thức và luyện tập qua các bài đánh giá.

\subsection{Hỗ trợ đánh giá kiến thức}

Hệ thống cần cung cấp cơ chế đánh giá để người dùng xác định mức độ hiểu bài, bao gồm:
\begin{itemize}
    \item Tạo và thực hiện bài kiểm tra trực tuyến với chấm điểm tự động.
    \item Lưu trữ kết quả và thống kê hiệu suất học tập.
\end{itemize}

\subsection{Hỗ trợ theo dõi tiến trình học tập}

Hệ thống cần ghi nhận và phân tích dữ liệu hoạt động học tập của người dùng, bao gồm: quá trình học Flashcard, kết quả bài kiểm tra, thời gian học tập, tiến độ hoàn thành mục tiêu và lịch sử học tập.

\subsection{Hỗ trợ cá nhân hóa trải nghiệm học tập}

Hệ thống cần thích nghi với nhu cầu của từng người dùng thông qua phân tích kết quả và lịch sử học tập, từ đó xác định nội dung cần ôn tập và đề xuất các hoạt động học tập phù hợp.

\subsection{Hỗ trợ quản lý mục tiêu và duy trì động lực học tập}

Hệ thống cần hỗ trợ người dùng xây dựng và duy trì thói quen học tập dài hạn, bao gồm: quản lý mục tiêu và công việc học tập, quản lý thời gian (Pomodoro), nhắc nhở học tập và theo dõi mức độ hoàn thành kế hoạch.

\subsection{Hỗ trợ cộng tác và chia sẻ tri thức}

Hệ thống cần hỗ trợ học tập nhóm thông qua các chức năng chia sẻ nội dung, cộng tác trên ghi chú và làm việc cùng nhau trên một nguồn dữ liệu chung.

\subsection{Hỗ trợ đa nền tảng}

Hệ thống cần đảm bảo người dùng có thể truy cập và đồng bộ dữ liệu nhất quán trên cả nền tảng Web và thiết bị di động.
