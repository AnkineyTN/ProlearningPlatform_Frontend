...
Từ những vấn đề trên, nhóm nhận thấy cần có một giải pháp hỗ trợ người học quản lý toàn bộ quá trình học tập trên cùng một nền tảng tích hợp. Xuất phát từ nhu cầu thực tế đó, nhóm thực hiện đề tài \textbf{``Hệ thống thông minh hỗ trợ học tập''} với mục tiêu xây dựng một nền tảng cho phép người dùng quản lý tài nguyên học tập, ghi chú kiến thức, tạo nội dung học tập bằng trí tuệ nhân tạo, ôn tập, đánh giá và theo dõi tiến trình trên nhiều nền tảng khác nhau. Hệ thống hướng tới việc giảm thao tác thủ công, nâng cao hiệu quả tự học và hỗ trợ người dùng xây dựng thói quen học tập bền vững.


\section{Mục tiêu đề tài}

Trên cơ sở các vấn đề đã phân tích, đề tài hướng tới xây dựng một hệ thống học tập thông minh có khả năng kết nối các hoạt động học tập rời rạc thành một quy trình thống nhất. Phần này trình bày mục tiêu tổng quát, mục tiêu chức năng, mục tiêu kỹ thuật, nhóm người dùng hướng đến và các lợi ích kỳ vọng của hệ thống.

\subsection{Mục tiêu tổng quát}

Đề tài hướng tới xây dựng một hệ thống hỗ trợ học tập thông minh, cho phép người dùng quản lý tài liệu, ghi chú, Flashcard, bài kiểm tra, mục tiêu học tập và tiến trình học tập trên một nền tảng thống nhất. Hệ thống ứng dụng trí tuệ nhân tạo để hỗ trợ tạo nội dung học tập, tóm tắt và khai thác tài liệu, tự động hóa một số tác vụ chuẩn bị nội dung ôn tập và nâng cao hiệu quả tự học.

Thông qua việc liên kết các hoạt động học tập vốn thường được thực hiện rời rạc, hệ thống giúp người dùng giảm thời gian quản lý công cụ, tăng khả năng tổ chức tri thức cá nhân, chủ động luyện tập và theo dõi mức độ tiến bộ của bản thân. Bên cạnh việc đáp ứng nhu cầu học tập hiện tại, đề tài cũng hướng tới xây dựng nền tảng có khả năng mở rộng, tạo cơ sở cho việc tích hợp thêm các giải pháp trí tuệ nhân tạo và cá nhân hóa học tập trong tương lai.
...
\begin{itemize}
    ...
    \item Ứng dụng trí tuệ nhân tạo để tóm tắt tài liệu, giải thích khái niệm, sinh Flashcard, sinh câu hỏi kiểm tra và tạo tài nguyên học tập.
...
Về mặt kỹ thuật, đề tài hướng tới xây dựng một hệ thống có kiến trúc rõ ràng, dễ mở rộng, dễ bảo trì và phù hợp với yêu cầu thực tế của một ứng dụng học tập hiện đại. Hệ thống được thiết kế theo mô hình Client--Server kết hợp định hướng dịch vụ, trong đó giao diện người dùng, nghiệp vụ, dữ liệu và trí tuệ nhân tạo được phân tách theo trách nhiệm riêng.
...
\subsection{Lợi ích mang lại}

Việc xây dựng hệ thống thông minh hỗ trợ học tập mang lại các lợi ích chính sau:
\begin{itemize}
    \item Giảm sự phân tán tài nguyên bằng cách tập trung hoạt động quản lý kiến thức, ghi chú, ôn tập và đánh giá trên cùng một nền tảng.
    \item Giảm khối lượng công việc thủ công nhờ ứng dụng trí tuệ nhân tạo trong quá trình chuẩn bị và tổ chức nội dung học tập.
    \item Hỗ trợ người học chuyển từ phương pháp học thụ động sang học tập chủ động thông qua ôn tập, kiểm tra và đánh giá thường xuyên.
    \item Giúp người dùng theo dõi tiến trình, nhận biết sự tiến bộ và duy trì động lực học tập trong dài hạn.
    \item Tạo nền tảng cho việc nghiên cứu và phát triển các hệ thống học tập cá nhân hóa trong tương lai.
\end{itemize}
...
Ứng dụng Web được phát triển bằng React và TypeScript, ứng dụng Mobile được phát triển bằng React Native, Backend Service được phát triển bằng Java Spring Boot, còn AI Service được phát triển bằng Python FastAPI và tích hợp với các mô hình ngôn ngữ lớn. Dữ liệu bền vững được lưu trữ chủ yếu trên PostgreSQL; Redis được sử dụng cho cache và trạng thái ngắn hạn; RabbitMQ hỗ trợ xử lý các tác vụ bất đồng bộ như gửi email hoặc thông báo nền.

\subsection{Giới hạn của đề tài}

Do giới hạn về thời gian, nguồn lực và phạm vi của đồ án tốt nghiệp, hệ thống vẫn còn một số giới hạn. Thứ nhất, chất lượng đầu ra của các chức năng AI phụ thuộc vào chất lượng dữ liệu đầu vào và khả năng của mô hình được sử dụng. Thứ hai, hệ thống tập trung vào các loại tài liệu học tập phổ biến như văn bản, PDF, bài trình chiếu và nội dung website; các dạng học liệu phức tạp hơn như mô phỏng tương tác hoặc thực tế ảo chưa nằm trong phạm vi nghiên cứu. Thứ ba, hệ thống được tối ưu chủ yếu cho học sinh, sinh viên và người tự học; các nhu cầu đặc thù của doanh nghiệp hoặc tổ chức đào tạo quy mô lớn chưa được xem xét đầy đủ.


\section{Phương pháp thực hiện}

Để thực hiện đề tài, nhóm áp dụng phương pháp phát triển phần mềm theo hướng lặp và tăng trưởng (Iterative and Incremental Development), kết hợp với quy trình Agile Scrum. Cách tiếp cận này phù hợp với đặc thù của hệ thống học tập thông minh, trong đó yêu cầu chức năng, giao diện người dùng và các khả năng AI cần được điều chỉnh qua nhiều vòng phản hồi.

Trong quá trình thực hiện, nhóm tổ chức công việc theo Product Backlog, phân rã yêu cầu thành các hạng mục có thể triển khai theo từng Sprint. Mỗi Sprint gồm các hoạt động chính như lập kế hoạch, triển khai, tích hợp, kiểm thử, đánh giá kết quả và điều chỉnh backlog cho vòng lặp tiếp theo.

Quá trình thực hiện đề tài được chia thành các giai đoạn chính như sau:

\subsection{Khảo sát và phân tích yêu cầu}

Nhóm khảo sát các hệ thống học tập hiện có, nghiên cứu nhu cầu người học và xác định các vấn đề cần giải quyết. Kết quả khảo sát được dùng để xây dựng yêu cầu chức năng, yêu cầu phi chức năng và phạm vi triển khai.

\subsection{Thiết kế hệ thống}

Nhóm thiết kế kiến trúc hệ thống, kiến trúc cơ sở dữ liệu, giao diện người dùng và các API phục vụ giao tiếp giữa các thành phần.

\subsection{Triển khai hệ thống}

Nhóm phát triển song song các thành phần Frontend Web, Frontend Mobile, Backend Service và AI Service theo từng Sprint nhằm rút ngắn thời gian phát triển và tăng khả năng phối hợp giữa các thành viên.

\subsection{Kiểm thử và hoàn thiện}

Sau mỗi giai đoạn triển khai, nhóm kiểm thử chức năng để phát hiện và xử lý lỗi phát sinh. Các phản hồi thu được trong quá trình kiểm thử và Sprint Review được sử dụng để cải thiện chất lượng sản phẩm trước khi hoàn thiện hệ thống.
