...
\begin{itemize}
    ...
    \item Ứng dụng mô hình ngôn ngữ lớn (LLM) để tóm tắt tài liệu, giải thích khái niệm, sinh Flashcard, sinh câu hỏi kiểm tra và tạo tài nguyên học tập.
...
\begin{itemize}
    ...
    \item Ứng dụng mô hình ngôn ngữ lớn (LLM) vào quy trình học tập, tự động hóa các tác vụ chuẩn bị và tổ chức nội dung, giảm đáng kể khối lượng công việc thủ công cho người học.
...
Trong thời gian thực hiện đề tài, nhóm tập trung triển khai các chức năng cốt lõi phục vụ quy trình học tập cá nhân. Một số nội dung không thuộc phạm vi của đề tài này bao gồm:
\begin{itemize}
    \item Chất lượng đầu ra của các chức năng AI phụ thuộc vào chất lượng dữ liệu đầu vào và năng lực của mô hình ngôn ngữ lớn được tích hợp; việc cải thiện hoặc thay thế mô hình AI không nằm trong phạm vi nghiên cứu này.
    \item Hệ thống hỗ trợ các định dạng tài liệu học tập phổ biến như văn bản, PDF, bài trình chiếu và nội dung website; các dạng học liệu tương tác phức tạp như mô phỏng hoặc thực tế ảo không thuộc phạm vi đề tài.
    \item Hệ thống được thiết kế và tối ưu cho đối tượng học sinh, sinh viên và người tự học; các yêu cầu đặc thù của doanh nghiệp hoặc tổ chức đào tạo quy mô lớn không nằm trong phạm vi xem xét.
\end{itemize}


\section{Phương pháp thực hiện}

Nhóm sử dụng Scrum để tổ chức và quản lý quá trình phát triển. Công việc được chia thành các Sprint kéo dài hai tuần, mỗi Sprint bao gồm lập kế hoạch, triển khai, kiểm thử và đánh giá kết quả. Các yêu cầu chức năng được phân rã thành các đầu việc cụ thể trong Product Backlog và được ưu tiên xử lý theo từng Sprint.

Quá trình thực hiện bao gồm bốn giai đoạn chính: khảo sát và phân tích yêu cầu; thiết kế kiến trúc hệ thống, cơ sở dữ liệu và giao diện; triển khai song song các thành phần Frontend Web, Mobile, Backend và AI Service; cuối cùng là kiểm thử và hoàn thiện sản phẩm dựa trên phản hồi từ các Sprint Review.
