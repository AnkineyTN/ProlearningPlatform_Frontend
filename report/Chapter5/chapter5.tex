...
\begin{itemize}
    ...
    \item \textbf{Trợ lý hỏi đáp (Chatbot) tích hợp trong ứng dụng:} Bổ sung chatbot cho phép người dùng hỏi đáp và tìm kiếm thông tin trực tiếp trong app thay vì phải chuyển qua lại nhiều tab trình duyệt -- một đề xuất được nhiều người dùng thử nghiệm nhắc đến trong khảo sát trải nghiệm (Mục~\ref{subsec:user-survey}).
