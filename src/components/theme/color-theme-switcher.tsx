...
const THEMES: {
  ...
  {
    id: 'atlas',
    label: 'Atlas · Forest Green',
    color: 'oklch(0.58 0.09 155)',
    darkColor: 'oklch(0.72 0.13 155)',
  },
  {
    id: 'lumen',
    label: 'Lumen · Ocean Blue',
    color: 'oklch(0.56 0.14 235)',
    darkColor: 'oklch(0.72 0.16 235)',
  },
  {
    id: 'ember',
    label: 'Ember · Amber',
    color: 'oklch(0.62 0.16 35)',
    darkColor: 'oklch(0.75 0.16 45)',
  },
];
  ...
  return (
    <TooltipProvider delayDuration={300}>
      <div
        className={cn(
          'flex items-center',
          collapsed ? 'flex-col gap-1 py-1' : 'flex-row gap-[6px] py-0.5',
        )}
      >
        {THEMES.map((t) => {
