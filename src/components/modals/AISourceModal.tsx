                        ...
                        {uploadedFiles.map((file, index) => {
                          ...
                          return (
                            <button
                              ...
                              title={actionLabel}
                              className='w-full flex items-center justify-between gap-2 p-2 transition-[background] duration-300 bg-[var(--pl-bg-sunken)] hover:bg-[var(--pl-bg-elevated)] rounded border border-border cursor-pointer text-left'
                            >
