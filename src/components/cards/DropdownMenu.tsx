    ...
    return (
        <div className="absolute right-0 mt-1 w-30 bg-card border border-border rounded-lg shadow-lg z-10 overflow-hidden">
            <Button
                variant="ghost"
                onClick={onUpdate}
                className="w-full transition-colors flex justify-start pl-3 items-center gap-2"
            >
            ...
            <Button
                variant="ghost"
                onClick={onDelete}
                className="w-full text-destructive hover:text-red-500 transition-colors flex justify-start pl-3 items-center gap-2"
            >
