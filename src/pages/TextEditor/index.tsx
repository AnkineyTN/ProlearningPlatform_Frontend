    ...
    return (
        <div ref={containerRef} className="min-h-screen bg-card flex relative">
            ...
            <div
                ...
                style={{
                    width: showFileSidebar && selectedFile ? `${editorWidthPercent}%` : '100%'
                }}
            >
                <EditorHeader
                    title={title}
            ...
            {showFileSidebar && selectedFile && (
                <div
                    ...
                    className={`w-1 hover:bg-purple-500 cursor-col-resize flex-shrink-0 transition-colors relative ${isResizing ? 'bg-purple-500' : ''
                        }`}
                >
                </div>
            )}
