...
export function StatCard({
  ...
  return (
    <div className='bg-[var(--pl-bg-elev)] border border-[var(--pl-border)] rounded-[14px] px-4 sm:px-5 pt-[18px] pb-5 overflow-hidden'>
      <div className='flex justify-between items-start'>
        <div className='text-[10px] tracking-[0.16em] uppercase text-[var(--pl-text-faint)]'>
          {kicker}
        </div>
        {icon && <span className='text-[var(--pl-accent)] shrink-0'>{icon}</span>}
      </div>
      <div className='flex items-baseline gap-[6px] mt-[14px]'>
        <span className='text-[28px] sm:text-[40px] font-semibold tracking-[-0.03em] leading-none text-[var(--pl-text)]'>
          {value}
        </span>
      ...
      <div className='mt-[10px] flex justify-between gap-2 text-[11px] text-[var(--pl-text-faint)]'>
