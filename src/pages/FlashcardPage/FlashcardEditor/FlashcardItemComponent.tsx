...
export default function FlashcardItemComponent({
  ...
  return (
    <div className="flex items-start gap-3 bg-card border border-border rounded-xl p-5 mb-3 hover:shadow-sm transition-shadow group">
      {/* Number + drag handle */}
      ...
      <div className="flex-1 grid grid-cols-2 gap-5">
        <div className="space-y-1.5">
          <textarea
            ...
            placeholder="Term"
            className="w-full rounded-lg px-3 py-2.5 bg-background border-b-2 border-border focus:border-primary focus:outline-none resize-none min-h-[90px] text-sm leading-relaxed transition-colors"
          />
          ...
          >
            {uploadImageMutation.isPending ? (
              ...
              <>
                ...
                <span className="text-[9px] uppercase tracking-wide">Image</span>
              </>
            )}
          </button>
        )}
