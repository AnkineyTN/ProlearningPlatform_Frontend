...
const SpacePicker = ({ open, selectedId, onClose, onSelect }: Props) => {
  ...
  return (
    <Dialog open={open} onOpenChange={(v) => !v && onClose()}>
      <DialogContent className="sm:max-w-3xl max-h-[80vh] overflow-hidden flex flex-col">
        <DialogHeader>
          <DialogTitle>{t("pomodoro.spaces.title")}</DialogTitle>
        </DialogHeader>
                ...
                >
                  ...
                  {s.source === "USER" && (
                    <button
                      ...
                      onClick={(e) => {
                        e.stopPropagation();
                        if (window.confirm(t("pomodoro.spaces.confirmDelete"))) {
