...
const TodoStats = ({ completedCount, totalTodos, goalsCount }: TodoStatsProps) => {
  ...
  const stats = [
    { label: t("todo.stats.completed"), value: completedCount, Icon: CheckCircle2, color: "oklch(0.72 0.15 155)" },
    { label: t("todo.stats.pending"), value: totalTodos - completedCount, Icon: Circle, color: "var(--pl-accent)" },
    { label: t("todo.stats.total"), value: totalTodos, Icon: Flag, color: "var(--pl-text-faint)" },
    { label: t("todo.stats.goals"), value: goalsCount, Icon: Target, color: "var(--pl-text-faint)" },
  ];
