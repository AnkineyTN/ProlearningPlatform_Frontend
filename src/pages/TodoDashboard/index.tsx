...
const TodoDashboard = () => {
  const [tasks, setTasks] = useState([
    {
      id: 1,
      title: 'Finish the sales presentation for the client meeting at 2:00',
      category: 'Work',
      completed: false,
      priority: 'high',
      dueDate: '2023-09-25',
    ...
    <div className='min-h-screen p-6'>
      <div className='max-w-7xl mx-auto'>
        ...
        <div className='grid grid-cols-1 md:grid-cols-4 gap-4 mb-6'>
          <div className='bg-[var(--pl-bg)] rounded-2xl p-6 shadow-sm hover:shadow-md transition-shadow'>
            ...
            <h3 className='text-2xl font-bold text-foreground0'>
              {completedToday}
            </h3>
          ...
          <div className='bg-[var(--pl-bg)] rounded-2xl p-6 shadow-sm hover:shadow-md transition-shadow'>
            <div className='flex items-center justify-between mb-2'>
              ...
              <span className='text-sm text-text-pinked font-semibold'>
                3 due
              </span>
            </div>
        ...
        <div className='grid grid-cols-1 lg:grid-cols-3 gap-6'>
          ...
          <div className='lg:col-span-2 space-y-6'>
            ...
            <div className='flex gap-3 overflow-x-auto pb-2'>
              {categories.map((cat) => (
                <Button
                  ...
                  className={`px-6 py-3 rounded-xl font-semibold whitespace-nowrap transition-all cursor-pointer ${
            ...
            {/* Add New Task */}
            <div className='bg-[var(--pl-bg)] rounded-2xl p-6 shadow-sm'>
                    ...
                    <div
                      ...
                      className={`flex items-center gap-4 p-4 rounded-xl border-2 transition-all hover:shadow-md ${
                        task.completed
                          ...
                          : 'bg-[var(--pl-bg)] border-ring hover:border-purple-500'
                      }`}
                    >
                      <Button
                        variant={'ghost'}
          ...
          <div className='space-y-6'>
            ...
            {/* Quick Stats */}
            <div className='bg-[var(--pl-bg)] rounded-2xl p-6 shadow-sm'>
              <h3 className='text-lg font-bold text-foreground0 mb-4'>
                Quick Stats
              </h3>
              <div className='space-y-3'>
